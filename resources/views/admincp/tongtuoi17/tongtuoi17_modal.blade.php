...
<div class="col-sm-3 ">
   <div class="form-group">
      ...
      {!! Form::text('tinhtrangcha',isset($show_tongtuoi17) ? $show_tongtuoi17->tinhtrangcha: '', ['class'=>'form-control','id'=>'tinhtrangcha']) !!}
  </div>
</div>
<div class="col-sm-3">
 <div class="form-group">
...
<div class="col-sm-3 ">
   <div class="form-group">
      ...
      {!! Form::text('tinhtrangme',isset($show_tongtuoi17) ? $show_tongtuoi17->tinhtrangme: '', ['class'=>'form-control','id'=>'tinhtrangme']) !!}
  </div>
</div>
<div class="col-sm-3">
 <div class="form-group">
